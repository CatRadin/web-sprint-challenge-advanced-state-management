...
//2. Replace the single Smurf component instance with a map return a Smurf component for each entry in the smurfs list. ✔️
//3. Replace the static isLoading variable with the state loading variable.✔️